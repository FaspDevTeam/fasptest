...
int main (int argc, const char * argv[]) 
{
    ...
    printf("------------------------------------------------------------------\n");
    printf("Classical(RS) AMG (direct interp) V-cycle as iterative solver ...\n");	
    ...
    printf("------------------------------------------------------------------\n");
    printf("Classical(RS) AMG (standard interp) V-cycle as iterative solver ...\n");	
    ...
    /* AMG V-cycle (Direct interpolation) with GS smoother as a solver */			
    printf("------------------------------------------------------------------\n");
    printf("Classic(AC1) AMG (direct interp) V-cycle as iterative solver ...\n");	
    ...
    /* AMG V-cycle (Standard interpolation) with GS smoother as a solver */			
    printf("------------------------------------------------------------------\n");
    printf("Classic(AC1) AMG (standard interp) V-cycle as iterative solver ...\n");	
    ...
    /* AMG V-cycle (Direct interpolation) with GS smoother as a solver */			
    printf("------------------------------------------------------------------\n");
    printf("Classic(AC2) AMG (direct interp) V-cycle as iterative solver ...\n");	
    ...
    /* AMG V-cycle (Standard interpolation) with GS smoother as a solver */			
    printf("------------------------------------------------------------------\n");
    printf("Classic(AC2) AMG (standard interp) V-cycle as iterative solver ...\n");	
    ...
    printf("------------------------------------------------------------------\n");
    printf("UA AMG NL-AMLI-CYCLE as iterative solver ...\n");	
    ...
    /* AMG V-cycle (Standard interpolation) with GS smoother as a solver */			
    printf("------------------------------------------------------------------\n");
    printf("SA AMG V-CYCLE as iterative solver ...\n");	
